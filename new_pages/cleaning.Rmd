# ဒေတာရှင်းလင်းခြင်းနှင့် အဓိကfunctionများ {}
...
ဤသင်ခန်းစာသည် ဒေတာအတွဲတစ်ခုကို “ရှင်းလင်း”ရာတွင် အသုံးပြုလေ့ရှိသော အဆင့်များကို သရုပ်ပြထားပြီး မရှိမဖြစ်လိုအပ်သော R ဒေတာစီမံခန့်ခွဲမှုfunctionများစွာ၏ အသုံးပြုပုံကိုလည်း ရှင်းပြထားပါသည်။ 

ဒေတာရှင်းလင်းခြင်းကို သရုပ်ပြရန်၊ ဤသင်ခန်းစာသည် raw case linelist datasetကို importလုပ်ခြင်းဖြင့် စတင်ပြီး ဒေတာရှင်းရေးလုပ်ငန်းစဉ်ကို အဆင့်ဆင့်လုပ်ဆောင်ပါမည်။ R codeတွင်၊ ၎င်းသည် လုပ်ဆောင်ချက်တစ်ခုမှ နောက်တစ်ခုသို့ dataset တစ်ခုကို လွှဲပြောင်းပေးနိုင်သည့် "pipe" အော်ပရေတာ `%>%` ကို ရည်ညွှန်းသော "pipe" ကွင်းဆက်တစ်ခုအဖြစ် ရှိပါသည်။


### အဓိကလုပ်ဆောင်ချက်များ {.unnumbered}  

ဤလက်စွဲစာအုပ်တွင် R package အစုတစ်ခုဖြစ်သည့် [**tidyverse**](https://www.tidyverse.org/) မှ functionများကို အလေးပေးဖော်ပြထားပါသည်။ ဤသင်ခန်းစာတွင်လုပ်ဆောင်ရမည့် မရှိမဖြစ်လိုအပ်သော R functionများကို အောက်တွင်ဖော်ပြထားပါသည်။

ဤfunctionအများစုသည် data manipulation challengeများ (ဒေတာခြယ်လှယ်နိုင်စွမ်းများ) ကိုဖြေရှင်းရန် “verb” functionများကို ပံ့ပိုးပေးသည့် [**dplyr**](https://dplyr.tidyverse.org/) R packageတွင် ပါဝင်ပါသည်။ (ဤအမည်သည် “dataframe-[plier](https://www.thefreedictionary.com/plier#:~:text=also%20ply%C2%B7er%20(pl%C4%AB%E2%80%B2၊ ကိုင်ဆောင်ထားသည်%2C%20 %2C%20or%20cutting.)” ကိုရည်ညွှန်းထားပါသည်။). **dplyr** သည် **tidyverse** R packageများ၏ တစ်စိတ်တစ်ပိုင်းဖြစ်သည် (**ggplot2**၊ **tidyr**၊ **stringr** ၊ **tibble**၊ **purrr**၊ **magrittr** နှင့် **forcats** တို့လည်း ပါဝင်သည်။)။ 


Function       | အသုံးဝင်ပုံ                               | Package
---------------|---------------------------------------|------------------------------
` %>% `|လုပ်ဆောင်ချက်တစ်ခုမှ နောက်တစ်ခုသို့ ဒေတာကို ”pipe"လုပ်ခြင်း (ဆက်ပေးခြင်း/ကမ်းလှမ်းခြင်း)|**magrittr** 
`mutate()`|columnများကို ဖန်တီး(create)၊ ပြောင်းလဲ (transform)ပြီး ပြန်သတ်မှတ်(redefine)လုပ်ခြင်း|**dplyr**  
`select()`|columnများကို ထားထားခြင်း၊ ဖယ်ရှားခြင်း၊ ရွေးချယ်ခြင်း သို့မဟုတ် နာမည်ပြန်ပြောင်းခြင်း|**dplyr**
`rename()`|columnများကို နာမည်ပြန်ပြောင်းခြင်း|**dplyr** 
`clean_names()`|columnအမည်များ၏ syntax ကို စံသတ်မှတ်ခြင်း|**janitor**
`as.character()`, `as.numeric()`, `as.Date()`, etc.|columnတစ်ခု၏ အမျိုးအစားကို ပြောင်းခြင်း|**base** R
`across()`|columnများစွာကို တစ်ချိန်တည်းတွင် ပြောင်းလဲခြင်း|**dplyr** 
**tidyselect** functions|columnများကို ရွေးချယ်ရန် logicကို အသုံးပြုခြင်း|**tidyselect**   
`filter()`|အချို့rowများကို ထားထားခြင်း|**dplyr** 
`distinct()`|တူနေသော/ထပ်နေသော rowများကို ဖျက်ခြင်း|**dplyr** 
`rowwise()`|rowတစ်ခုစီအတွင်း/မှ လုပ်ဆောင်မှုများ|**dplyr**  
`add_row()`|rowများကို ကိုယ်တိုင်ထည့်ခြင်း|**tibble** 
`arrange()`|rowများကို အစဥ်လိုက်စီခြင်း|**dplyr**
`recode()`|ကော်လံတစ်ခုတွင် တန်ဖိုးများကို ကုဒ်ပြန်လုပ်ခြင်း|**dplyr** 
`case_when()`|ပိုမိုရှုပ်ထွေးသော ယုတ္တိစံနှုန်း(logical criteria)များကို အသုံးပြပြီး columnတစ်ခုတွင် တန်ဖိုးများကို ကုဒ်ပြန်လုပ်ခြင်း|**dplyr** 
`replace_na()`, `na_if()`, `coalesce()`|ကုဒ်ပြန်လုပ်ခြင်းအတွက် အထူးfunctionsများ|**tidyr**  
`age_categories()` နှင့် `cut()`|ကိန်းဂဏန်း(numeric) columnတစ်ခုမှ အမျိုးအစားအလိုက် အုပ်စုများ (categorical group)ကို ဖန်တီးခြင်း|**epikit** နှင့် **base** R
`clean_variable_spelling()`|ဒေတာအဘိဓာန်ကို အသုံးပြုပြီး တန်ဖိုးများကို ကုဒ်ပြန်လုပ်ခြင်း/ရှင်းလင်းခြင်း|**linelist**
`which()`|logical criteriaများကို အသုံးပြုခြင်း။; အညွှန်းကိန်းများသို့ ပြန်သွားခြင်း|**base** R

ဤfunctionများကို Stata သို့မဟုတ် SAS commandများနှင့် နှိုင်းယှဉ်ကြည့်လိုပါက [R သို့ ပြောင်းလဲအသုံးပြုခြင်း] သင်ခန်းစာကို ကြည့်ပါ။
...
​​`:=` နှင့် မကြာခဏအသုံးပြုသော ကွင်းပိတ်များ `[ ]` ကဲ့သို့သော အော်ပရေတာများပါရှိသော **data.table** R ပက်ကေ့ခ်ျမှ အစားထိုးဒေတာစီမံခန့်ခွဲမှုမူဘောင်တစ်ခုကို သင်ကြုံတွေ့ရနိုင်သည်။ ဤလုပ်ငန်းစဥ်နှင့် syntaxကို [ဒေတာဇယားများ] သင်ခန်းစာတွင် အတိုချုံးရှင်းပြထားသည်။

### အမည်စာရင်း (Nomenclature) {.unnumbered}  

ဤလက်စွဲစာအုပ်တွင် ကျွန်ုပ်တို့သည် ယေဘုယျအားဖြင့် "ကိန်းရှင်များ" (variables) နှင့် "လေ့လာချက်များ" (observations) အစား "columnများ" နှင့် "rowများ" ကို ရည်ညွှန်းပါသည်။ ["tidy data"](https://tidyr.tidyverse.org/articles/tidy-data.html) တွင် ရှင်းပြထားသည့်အတိုင်း၊ ကူးစက်ရောဂါဆိုင်ရာ စာရင်းအင်းဒေတာအတွဲအများစုတွင် rowများ၊ columnများနှင့် တန်ဖိုးများ ဖွဲ့စည်းတည်ဆောက်ပုံအရ ပါဝင်သည်။

*Variables* တွင် တူညီသော အရင်းခံ အရည်အချင်းကို တိုင်းတာသည့် တန်ဖိုးများ (အသက်အုပ်စု၊ ရလဒ် သို့မဟုတ် စတင်သည့် နေ့စွဲကဲ့သို့) ပါရှိသည်။ *Observations* သည် တူညီသောယူနစ်ပေါ်တွင် တိုင်းတာထားသော တန်ဖိုးများအားလုံး (ဥပမာ လူတစ်ဦး၊ တည်နေရာ၊ သို့မဟုတ် ဓာတ်ခွဲခန်းနမူနာ) ပါဝင်သည်။ ဒါကြောင့် ဒီအချက်တွေကို သိသာထင်ရှားစွာ သတ်မှတ်ဖို့ ပိုခက်ခဲနိုင်ပါတယ်။

"tidy" ဒေတာအတွဲများတွင်၊ columnတစ်ခုစီသည် variable တစ်ခု ဖြစ်သည်၊ rowတစ်ခုစီသည် observation တစ်ခု ဖြစ်ပြီး ဆဲလ်တစ်ခုစီသည် တန်ဖိုးတစ်ခုတည်းဖြစ်သည်။ သို့သော် သင်ကြုံတွေ့ရမည့် ဒေတာအတွဲအချို့သည် ဤပုံစံအတိုင်း အံကိုက်မဟုတ်ပါ - column အများအပြားတလျှောက်တွင် ပိုင်းခြားထားသော variableတစ်ခုသည် "wide" format ဒေတာအတွဲတွင် ရှိသည်။ ( [Pivoting data] သင်ခန်းစာတွင် နမူနာကိုကြည့်ပါ)။ အလားတူ၊ observationများကို rowများစွာတွင် ပိုင်းခြားနိုင်သည်။

ဤလက်စွဲစာအုပ်၏ အစိတ်အပိုင်းအများစုသည် ဒေတာကို စီမံခန့်ခွဲခြင်းနှင့် အသွင်ပြောင်းခြင်းအကြောင်းဖြစ်သည်၊ ထို့ကြောင့် rowများနှင့် columnများ၏ ခိုင်မာသောဒေတာဖွဲ့စည်းပုံများကို ရည်ညွှန်းခြင်းသည် ယေဘုယျobservationများနှင့် variableများထက် ပိုမိုဆီလျော်ပါသည်။ ခြွင်းချက်များသည် data analylsisဆိုင်ရာ သင်ခန်းစာများတွင် အဓိကအားဖြင့် ဖြစ်ပေါ်ပြီး variableများနှင့် observationများကို ပိုမိုကိုးကားထားတာကို သင်တွေ့မြင်ရမည်ဖြစ်သည်။
...
<!-- ======================================================= -->
<!-- ======================================================= -->
## pipelineကို ရှင်းလင်းခြင်း

**ဤစာမျက်နှာသည် ပုံမှန်ရှင်းလင်းရေးအဆင့်များမှတဆင့် ဆက်လက်လုပ်ဆောင်ပြီး ၎င်းတို့ကို ရှင်းလင်းရေးပိုက်ကွင်းpipe chainတစ်ခုသို့ ဆက်တိုက်ထပ်ထည့်ထားပါသည်။**

ကူးစက်ရောဂါခွဲခြမ်းစိတ်ဖြာခြင်းနှင့် ဒေတာလုပ်ဆောင်ခြင်းတွင်၊ မကြာခဏ ရှင်းလင်းရေးအဆင့်များကို ဆက်တိုက်လုပ်ဆောင်ပြီး အတူတကွ ချိတ်ဆက်လုပ်ဆောင်လေ့ရှိသည်။ R တွင်၊ ၎င်းသည် *rawဒေတာအတွဲကို ဖြတ်သွားခြင်း သို့မဟုတ်  ရှင်းလင်းရေးအဆင့်တစ်ခုမှ နောက်တစ်ခုသို့ “piped” လုပ်ခြင်း* ဖြစ်သည့် ရှင်းလင်းရေး "pipeline" အဖြစ် မကြာခဏ ထင်ရှားသည်။

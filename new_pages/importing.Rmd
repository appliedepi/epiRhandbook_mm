...
အကြံပြုချက်- သင်၏RStudio ဝင်းဒိုးနောက်တွင် pop-up window ပေါ်လာနိုင်သည်။
...
သတိပြုရန်- vector များအားလုံးသည် တူညီသောအရှည်ဖြစ်ရမည် (တူညီသောတန်ဖိုးများ)။
...
၎င်းသည် data frame linelistကို Excel workbook အဖြစ် working directory/R project root ဖိုဒါတွင် သိမ်းဆည်းသည်-
...
`.Rdata` files can store multiple R objects - for example multiple data frames, model results, lists, etc. This can be very useful to consolidate or share a lot of your data for a given project. .Rdataဖိုင်များသည် R objectများစွာကို သိမ်းဆည်းထားနိုင်သည် - ဥပမာ data frameများစွာ၊ မော်ဒယ်ရလဒ်များ၊ စာရင်းများ စသည်တို့သည် ပေးအပ်ထားသော ပရောဂျက်တစ်ခုအတွက် သင့်ဒေတာအများအပြားကို စုစည်းရန် သို့မဟုတ် မျှဝေရန်အတွက် အလွန်အသုံးဝင်ပါသည်။
...
မှတ်ချက်- စာရင်းတစ်ခုကို importရန် ကြိုးစားနေပါ က မူရင်းဖွဲ့စည်းပုံနှင့် အကြောင်းအရာအပြည့်အစုံဖြင့် ၎င်းကိုimportရန် ရီယိုမှ [import_list()](https://rdrr.io/pkg/rio/man/import_list.html) ကိုအသုံးပြုပါ။
